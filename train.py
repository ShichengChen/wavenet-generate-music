...
songnum=45
filterSize = 3
savemusic='vsCorpus/accompaniment{}.wav'
#savemusic0='vsCorpus/nus10xtr{}.wav'
#savemusic1='vsCorpus/nus11xtr{}.wav'
resumefile = 'model/accompaniment'  # name of checkpoint
lossname = 'accompanimentloss1.txt'  # name of loss file
...
def train(epoch):
    for iloader, ytrain in loadtr:
        ...
        #when sample rate is samplesize//2, the result is better
